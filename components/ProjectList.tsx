...
import { fetchProject, deleteProject, deleteTask } from "@/lib/api";
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="px-3 py-1 bg-indigo-600 text-white rounded hover:bg-indigo-700 w-full"
                  >
                ...
                {project.tasks && project.tasks.length > 0 ? (
                  <ul className="space-y-2">
                    {project.tasks.map((task) => (
                      <li
                        key={task.id}
                        className="flex justify-between items-center p-2 bg-white/80 dark:bg-gray-600/50 rounded-md"
                      >
